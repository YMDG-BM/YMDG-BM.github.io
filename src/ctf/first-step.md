...
:::important
我们在[本博客](https://kanade-chan.top/)上所提供的任何PoC、exp以及漏洞利用原理详解等，均已经得到官方授权，或是在受限与比赛环境中进行。请勿使用我们提供的任何PoC与exp在任何非授权环境下进行任何渗透测试与攻击。任何基于本博客提供的PoC与exp所发起的未授权网络攻击均与本博客及作者无关。
:::
---
