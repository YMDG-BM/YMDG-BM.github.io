...
::: tip
本文某处藏匿着一个flag，或许可以提交到[这里](https://kanade-chan.top/assets/html/first-ctf.html)？
:::
...
[^first]: 恭喜你找到了第一个flag！你可以把这个flag复制下来，跳转到[这里](https://kanade-chan.top/assets/html/first-ctf.html) 。试着把这个flag题交上去吧！这或许是你人生中找到的第一个flag，意味着你在网络安全领域迈出的第一步。
